...
shinyUI(
  dashboardPage(skin = "blue",
    dashboardHeader(title = "NYC School"),
    dashboardSidebar(
      sidebarMenu(
        menuItem("Intro", tabName = "menuDash", icon = icon("Intro")),
        menuItem("Map", tabName = "menuMap", icon = icon("map")),
        menuItem("Stat", tabName = "menuChart", icon = icon("chart-line")),
        menuItem("Data", tabName = "menuData", icon = icon("data-line"))
    ...
    dashboardBody(
      tabItems( 
        tabItem(tabName = "menuDash",
                    fluidPage(
                      fluidRow(
                        box(width = 12, title = "Introduction", status = "warning",
                      ...
                      fluidRow(box(width = 12, title = "User Guide", status = "warning",
