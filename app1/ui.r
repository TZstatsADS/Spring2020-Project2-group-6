                    ...
                    box(width = 15, title = "Introduction", status = "primary",
                        ...
                        h3(
                          tags$div(tags$ul(
                           ...
                           the best school option within the familyâ€™s housing budget. 
                           ...
                           understanding of the school they are attending with the schoolâ€™s 
                  ...
                  fluidRow(box(width = 15, title = "User Guide", status = "primary",
                               ...
                               h3(
                                 tags$div(tags$ul(
                                   ...
                                   tags$li("Comparison Chart: In this page, you can compare any two schools by selecting or entering their borough numbers (BN), which can be found in the â€œDataâ€? page. The comparison contains two tabs: â€œTotal Enrollment & Quality Reviewâ€?, and â€œDemographic Informationâ€?. The first tab shows the schoolâ€™s total enrollment number from 2015-2019, and its newest quality review score. The second tab includes the schoolsâ€? demographic information including gender, ethnicity, and percentage of ESL(English as Second Language) student."),
                                   tags$li("Data & Ranking: This page shows all of the available information of schools. You can use this page to search for a schoolâ€™s borough number (BN), look for complete information of a specific school, or look at the school ranking according to a specific aspect."),
                                   tags$li("Source: This part includes the link to the website where we get our data from. All of our data are from â€˜NYC open dataâ€?, and the starter code is from the class website on Github.")
                                 ))))
                               )
